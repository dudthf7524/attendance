            ...
            <div ref={ctnDom} className="w-full h-full">
                ...
                {/* <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                        <h2 className="text-4xl md:text-6xl font-bold text-white drop-shadow-2xl mb-2">
                            TicTec
                        </h2>
                        <p className="text-lg md:text-xl text-white/80 drop-shadow-lg mb-6">
                            스마트한 출결관리
                        </p>
                        ...
                        <p className="text-xl md:text-2xl text-white mb-12 max-w-3xl mx-auto leading-relaxed  mt-6">
                            GPS 기반 정밀 위치 추적부터 자동화된 근태 관리까지,<br />
                            <strong>현장을 위한 완전한 출결 솔루션</strong>
                        </p>
                    </div>
