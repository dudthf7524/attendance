...
const EmployeeManagementPage = () => {
  ...
  return (
    <div className="h-screen w-full bg-[#f9fafb] px-4 py-8">
      <div className=" mx-auto bg-white border border-blue-200 rounded-xl shadow-sm px-6 py-4 mb-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6 h-[calc(100%-100px)] transition-all duration-500">
          ...
          <div className="flex-1 overflow-y-auto">
            {employees.map((emp) => (
              <button
                ...
                className={`w-full text-left px-5 py-4 border-b border-blue-100 hover:bg-blue-50 transition ${selected.id === emp.id
        ...
        {/* 직원 상세 정보 */}
        <div
          className="w-full lg:w-2/3 bg-white border border-blue-300 rounded-xl shadow-md p-6 transition-all duration-300 flex flex-col"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm flex-1 overflow-y-auto">
            <div>
              <p className="text-blue-400">부서</p>
              <p className="text-gray-800 font-medium">{selected.department}</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-blue-400">이메일</p>
              <p className="text-gray-800 font-medium">{selected.email}</p>
            </div>
            <div>
              <p className="text-blue-400">전화번호</p>
